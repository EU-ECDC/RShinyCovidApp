...
shinyUI(fluidPage(
    ...
    tabsetPanel(
        ...
        tabPanel("Forecasts", fluid = TRUE,
                 # Tab title
                 h4("Forecasted COVID-19 incidence over the next 28 days"),
                 ...
                 fluidRow(column(3, offset = 1, 
                          ...
                          column(4,
                                 ...
                                 radioButtons("type", "Type of forecasts",
                                              choices = list("Case forecasts (daily)" = 1, "Death forecasts (weekly)" = 2),
                                              selected = 1, inline = T),
                 ...
                 sidebarLayout(
                     sidebarPanel(
                         ...
                         radioButtons("nuts2", "Geographical resolution",
                                      choices = list("Coarse (NUTS-1 / NUTS-2)" = 1, "Fine (NUTS-3)" = 2),selected = 2, inline = T),
                         # What quantile of the prediction should be plotted (default = Median)
                         ...
                         radioButtons("type_map", "Type of incidence map (changes the left-side map)",
        ...
        tabPanel("Scenarios", fluid = TRUE,
                 ...
                 fluidRow(column(3, offset = 1, 
                                 ...
                                 # Show severe outcomes or cases
                                 radioButtons("type3", "Type of forecasts",
                                              choices = list("Case forecasts (daily)" = 1, "Death forecasts (weekly)" = 2),
                                              selected = 1, inline = T),
                                 # What Geographical resolution should be plotted (default = Fine (NUTS-3))
                 ...
                 measures (e.g. business and school closures, gathering bans, etc.) 
                 aimed at slowing the spread of COVID-19. The values presented here 
                 should be interpreted with caution since the effectiveness of NPIs depends on various factors, such as behaviour and 
